...
class Frame5(tk.Frame):
    def __init__(self, parent):
        ...
        # BOSS
        self.boss_img = tk.PhotoImage(file="./picture/Peacemaker's_Wings.png")
        ...
        # 物品2
        dropitem2_img = tk.PhotoImage(file='./picture/corona.png')
