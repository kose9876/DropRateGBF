...
class Frame6(tk.Frame):
    def __init__(self, parent):
        ...
        # BOSS
        self.boss_img = tk.PhotoImage(file="./picture/Ultimate_Bahamut.png")
        ...
        # 物品2
        dropitem2_img = tk.PhotoImage(file='./picture/Ultima_Unit_square.png')
        ...
        self.drop_items = [
            ...
            {'name': 'CPU', 'image': dropitem2_img},
            {'name': '粒子', 'image': dropitem3_img}
