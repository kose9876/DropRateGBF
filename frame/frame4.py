...
class Frame4(tk.Frame):
    def __init__(self, parent):
        ...
        # BOSS
        self.boss_img = tk.PhotoImage(file='./picture/Akasha.png')
        ...
        # 物品2
        dropitem2_img = tk.PhotoImage(file='./picture/key.png')
        ...
        self.drop_items = [
            ...
            {'name': '通往安德的鑰匙', 'image': dropitem2_img}
